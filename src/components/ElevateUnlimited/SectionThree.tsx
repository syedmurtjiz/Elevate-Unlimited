            ...
            <div className="bg-[#CCDDD7] rounded-lg h-screen flex flex-col items-center justify-center">
                <div className='flex flex-row items-center justify-center gap-4'>
                    <div className='relative'>
                        <img src="/Frame75.png" alt="personalized" className='w-50 h-50' />
                    ...
                    <div className='relative'>
                        <img src="/Frame76.png" alt="personalized" className='w-50 h-50' />
                    ...
                    <div className='relative'>
                        <img src="/Frame77.png" alt="personalized" className='w-50 h-50' />
                    ...
                    <div className='relative'>
                        <img src="/Frame79.png" alt="personalized" className='w-50 h-50' />
                ...
                <div className='flex flex-row items-center justify-center gap-4'>
                <div className='relative'>
                        <img src="/Frame 80.png" alt="personalized" className='w-50 h-50' />
                        <p className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-sm font-bold'>Gratitude and Abundance</p>
                    </div>
                    <div className='relative'>
                        <img src="/Frame 78.png" alt="personalized" className='w-50 h-50' />
                        <p className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-sm font-bold'>Gratitude and Abundance</p>
                    </div>
                    <div className='relative'>
                        <img src="/Frame 81.png" alt="personalized" className='w-50 h-50' />
                        <p className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-sm font-bold'>Gratitude and Abundance</p>
                    </div>
                </div>
            </div>
