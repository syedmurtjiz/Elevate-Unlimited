...
const SectionSix = () => {
  ...
  return (
    <div className='p-4'>
    <div className="relative min-h-screen bg-cover bg-center flex items-center justify-center bg-[url('/Top.png')] rounded-b-3xl  mx-auto">
      ...
      <div className="relative container mx-auto flex flex-col items-center justify-center min-h-screen text-center px-4">
        <motion.div
          ...
          className="flex flex-col items-center justify-center gap-8 max-w-3xl mx-auto"
        >
          {/* Main Heading */}
          <div className="text-center space-y-2">
            ...
            <h2 className="text-5xl md:text-5xl font-bold tracking-wide text-stroke">
              TRANSFORMATION
            <span className='text-white'>              TODAY
            </span>
            </h2>
