...
export default function SectionThree() {
  ...
  return (
    <div className="h-screen w-full bg-[url('/flower1.png')] bg-cover bg-top-center bg-no-repeat flex flex-col px-6 py-12">
      <div className="space-x-80">
        <ScrollAnimation direction="left" delay={0.2}>
          <div className="max-w-3xl">
            ...
            <p className="text-gray-700 leading-relaxed mb-12 max-w-2xl">
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {slides.map((slide, index) => (
                <div key={index} className="flex space-x-8 mt-8 w-full flex-shrink-0">
                  ...
                  <ScrollAnimation direction="right" delay={0.4}>
                    <div className="relative w-[400.08px] h-[250.53px] overflow-hidden rounded-lg">
                      ...
                      <div className="absolute inset-0 flex flex-col items-center">
                        ...
                        <div className="px-8">
                          <h3 className="text-base font-semibold text-white mb-1.5 text-center">{slide.right.title}</h3>
                          <p className="text-white text-xs leading-snug text-center">
